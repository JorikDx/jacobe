...
import styles from "../../styles/desktop/Reserve.module.css";
...
export const ReserveDesktop = () => {
    ...
    return (
        <>
            <Header option={HeaderOption.Reserve}/>
            <div className={styles.container}>
                ...
                <main className={styles.main}>
                    ...
                    <div className={styles.formInputs}>
                        ...
                        <PizzaModal selectedPizzas={pizzas} pushPizzas={updatePizzas} showModal={showModal} isModalVisible={isModalVisible} />
                        <div className={styles.inputContainer}>
